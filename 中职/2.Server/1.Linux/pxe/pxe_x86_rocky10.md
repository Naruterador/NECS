...
"pools": [ { "pool": "192.168.101.201 - 192.168.101.211" } ],
...
"data": "192.168.101.91" #对应tftp服务器地址
...
"data": "pxelinux.0" #对应pxelinux.0也就是启动文件
...
label manual
menu label ^Install Rockylinux10
kernel centos/vmlinuz
append initrd=centos/initrd.img  inst.repo=ftp://10.6.220.106/centos     inst.ks=ftp://10.6.220.105/kickstart.cfg

systemctl start kea-dhcp4
systemctl enable kea-dhcp4
systemctl start vsftpd   //开启vsftp匿名访问
systemctl enable vsftpd
systemctl restart tftp
systemctl enable tftp

##配置安装配置文件kickstart.cfg
cp /root/anaconda-ks.cfg  /var/ftp/kickstart.cfg
chmod 755 /var/ftp/kickstart.cfg

vi /var/ftp/kickstart.cfg
